    ...
    return (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#4A5156' }}>
            ...
            <View>
                ...
                <Text style={{ textAlign: 'center', justifyContent: 'center', flexDirection: 'column',color: '#E2EAE9'  }}>-Entrar a perfil de Usuario Buscado</Text>
                <Text style={{ textAlign: 'center', justifyContent: 'center', flexDirection: 'column',color: '#E2EAE9' }}>-Entrar a perfil de Película buscada</Text>
